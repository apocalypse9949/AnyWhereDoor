...
pip3 install -r requirements.txt  # After installing the virtual package install requirements.txt file to install access requirements run on this virtual env
if [ $? -eq 0 ]; then
